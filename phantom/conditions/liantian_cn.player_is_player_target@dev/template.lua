--[[
original: ../conditions/liantian_cn.player_is_player_target@dev/template.lua
uuid: {{uuid}}
plugin: liantian_cn.player_is_player_target@dev
摘要：玩家当前目标是否为自己。
描述：
    秘密布尔直接交给 Cell:setCellBoolean，不在 Lua 中分支。
...
local function update()
    ...
    cell:setCellBoolean(UnitIsUnit(UNIT_TOKEN, "target"))
end
