--[[
original: ../conditions/liantian_cn.player_has_talent@dev/template.lua
uuid: {{uuid}}
plugin: liantian_cn.player_has_talent@dev
摘要：玩家是否掌握任一候选天赋技能。
描述：
...
业务限制：按技能 ID 判断，不解析天赋树；与 player_has_spell 行为完全相同，事件后延迟 0.25 秒合并刷新。
