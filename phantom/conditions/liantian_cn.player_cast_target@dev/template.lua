--[[
original: ../conditions/liantian_cn.player_cast_target@dev/template.lua
uuid: {{uuid}}
...
旧项目参考：PhantomProject/src/0121_player_cast_target.lua；revision f6935113e686eb73785b8315c58368093012c959。
