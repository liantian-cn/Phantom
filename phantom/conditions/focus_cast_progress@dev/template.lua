--[[
original: ../conditions/focus_cast_progress@dev/template.lua
uuid: {{uuid}}
plugin: focus_cast_progress@dev
摘要：焦点施法或通道进度。
描述：
...
--[[
用途与签名：UnitCastingInfo("focus") 第 11 项 delayTimeMs、UnitChannelInfo("focus") 第 9 项 isEmpowered 是 NeverSecret 状态哨兵；UnitCastingDuration/UnitChannelDuration("focus") 返回 duration 或无值。color = duration:EvaluateElapsedPercent(curve) 接受颜色曲线并返回可能秘密的颜色。
