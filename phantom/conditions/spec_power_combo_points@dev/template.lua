--[[
original: ../conditions/spec_power_combo_points@dev/template.lua
uuid: {{uuid}}
摘要：显示玩家连击点整数。
描述：固定 ComboPoints，普通整数除以 255；秘密值、越界或非整数直接报错。
...
local POWER_TYPE = Enum.PowerType.ComboPoints -- 固定连击点
...
固定 player、ComboPoints、false；API 标记 SecretWhenUnitPowerRestricted。
