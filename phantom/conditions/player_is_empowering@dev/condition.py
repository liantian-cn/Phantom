...
Description:
    ...
    API：UnitCastingInfo("player") 第 11 项 delayTimeMs、UnitChannelInfo("player") 第 9 项 isEmpowered 是 NeverSecret；后者返回通道是否蓄力的布尔值，无通道时无值。
...
Key Variables:
    None
Change Log:
    2026-09-15: Added 按已确认的玩家条件迁移计划新增 player_is_empowering@dev。
"""
