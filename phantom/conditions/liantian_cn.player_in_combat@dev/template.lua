--[[
original: ../conditions/liantian_cn.player_in_combat@dev/template.lua
uuid: {{uuid}}
plugin: liantian_cn.player_in_combat@dev
摘要：玩家是否在战斗中。
描述：
...
local UnitAffectingCombat = UnitAffectingCombat -- 查询战斗状态

--[[
用途与签名：result = UnitAffectingCombat("player")；返回战斗布尔值。
业务限制：布尔值直接交给 Cell:setCellBoolean，经 EvaluateColorFromBoolean 显示黑白。
...
旧项目参考：PhantomProject/src/0107_player_in_combat.lua；revision f6935113e686eb73785b8315c58368093012c959。
