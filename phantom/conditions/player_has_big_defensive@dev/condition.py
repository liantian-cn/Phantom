...
Description:
    ...
    API：container = CreateFrame("AuraContainer", nil, parent, "CustomAuraContainerTemplate")；SetUnit("player")；AddAuraSlot(key, "HELPFUL|BIG_DEFENSIVE", options) 返回受管按钮；UpdateAllAuras() 请求刷新。
...
Key Variables:
    None
Change Log:
    2026-09-15: Added 按已确认的玩家条件迁移计划新增 player_has_big_defensive@dev。
"""
