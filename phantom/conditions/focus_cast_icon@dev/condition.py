...
Description:
    ...
    API：UnitCastingInfo/UnitChannelInfo("focus") 第 3 项返回可能秘密的 textureID；用 NeverSecret 的 delayTimeMs/isEmpowered 判断状态。
...
Key Variables:
    None
Change Log:
    2026-09-18: Added 按已确认的焦点条件迁移计划新增 focus_cast_icon@dev。
"""
