--[[
original: ../conditions/player_has_spell@dev/template.lua
uuid: {{uuid}}
plugin: player_has_spell@dev
摘要：玩家是否掌握任一候选技能。
描述：
    任一 ID 已知或在法术书中即为真；与 player_has_talent 行为完全相同，事件后延至下一帧刷新。
...
业务限制：任一 ID 已知或在法术书中即为真；与 player_has_talent 行为完全相同，事件后延至下一帧刷新。
