--[[
original: ../conditions/liantian_cn.player_trinket_ready@dev/template.lua
uuid: {{uuid}}
plugin: liantian_cn.player_trinket_ready@dev
摘要：玩家饰品是否准备就绪。
描述：
...
旧项目参考：PhantomProject/src/0115_player_trinket_ready.lua；revision f6935113e686eb73785b8315c58368093012c959。
