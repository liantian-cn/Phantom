--[[
original: ../conditions/liantian_cn.player_damage_absorb@dev/template.lua
uuid: {{uuid}}
plugin: liantian_cn.player_damage_absorb@dev
摘要：玩家伤害吸收量是否超过阈值。
描述：
...
旧项目参考：PhantomProject/src/0125_player_damage_absorb.lua；revision f6935113e686eb73785b8315c58368093012c959。
