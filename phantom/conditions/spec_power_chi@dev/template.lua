--[[
original: ../conditions/spec_power_chi@dev/template.lua
uuid: {{uuid}}
摘要：显示玩家真气整数。
描述：固定 Chi，普通整数除以 255；秘密值、越界或非整数直接报错。
...
local POWER_TYPE = Enum.PowerType.Chi -- 固定真气
...
固定 player、Chi、false；API 标记 SecretWhenUnitPowerRestricted。
