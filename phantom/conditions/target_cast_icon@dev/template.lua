--[[
original: ../conditions/target_cast_icon@dev/template.lua
uuid: {{uuid}}
...
--[[
用途与签名：UnitCastingInfo/UnitChannelInfo("target") 第 3 项返回可能秘密的 textureID；用 NeverSecret 的 delayTimeMs/isEmpowered 判断状态。
