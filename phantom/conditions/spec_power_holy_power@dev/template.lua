--[[
original: ../conditions/spec_power_holy_power@dev/template.lua
uuid: {{uuid}}
摘要：显示玩家神圣能量整数。
描述：固定 HolyPower，普通整数除以 255；秘密值、越界或非整数直接报错。
...
local POWER_TYPE = Enum.PowerType.HolyPower -- 固定神圣能量
...
固定 player、HolyPower、false；API 标记 SecretWhenUnitPowerRestricted。
