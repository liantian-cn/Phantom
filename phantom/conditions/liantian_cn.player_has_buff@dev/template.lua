--[[
original: ../conditions/liantian_cn.player_has_buff@dev/template.lua
uuid: {{uuid}}
plugin: liantian_cn.player_has_buff@dev
摘要：玩家是否有任一指定增益。
描述：
...
旧项目参考：PhantomProject/src/0127_player_has_buff.lua；revision f6935113e686eb73785b8315c58368093012c959。
