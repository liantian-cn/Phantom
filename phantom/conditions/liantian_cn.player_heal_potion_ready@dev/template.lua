--[[
original: ../conditions/liantian_cn.player_heal_potion_ready@dev/template.lua
uuid: {{uuid}}
plugin: liantian_cn.player_heal_potion_ready@dev
摘要：治疗药水是否准备就绪。
描述：
...
旧项目参考：PhantomProject/src/0118_player_heal_potion_ready.lua；revision f6935113e686eb73785b8315c58368093012c959。
