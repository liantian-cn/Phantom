--[[
original: ../conditions/spec_power_arcane_charges@dev/template.lua
uuid: {{uuid}}
摘要：显示玩家奥术充能整数。
描述：固定 ArcaneCharges，普通整数除以 255；秘密值、越界或非整数直接报错。
...
local POWER_TYPE = Enum.PowerType.ArcaneCharges -- 固定奥术充能
...
固定 player、ArcaneCharges、false；API 标记 SecretWhenUnitPowerRestricted。
