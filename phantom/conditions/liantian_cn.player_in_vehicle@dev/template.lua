--[[
original: ../conditions/liantian_cn.player_in_vehicle@dev/template.lua
uuid: {{uuid}}
plugin: liantian_cn.player_in_vehicle@dev
摘要：玩家是否在载具或坐骑中。
描述：
    任一为真即显示白色，普通坐骑也算。
...
旧项目参考：PhantomProject/src/0110_player_in_vehicle.lua；revision f6935113e686eb73785b8315c58368093012c959。
