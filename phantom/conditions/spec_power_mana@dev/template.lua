--[[
original: ../conditions/spec_power_mana@dev/template.lua
uuid: {{uuid}}
摘要：显示玩家法力比例。
描述：固定 Mana，秘密资源只经黑白曲线交给 Cell；初始化及资源事件刷新。
...
local POWER_TYPE = Enum.PowerType.Mana -- 固定法力资源
local insert = table.insert -- 注册初始化
--[[
UnitPowerPercent(unitToken, powerType, unmodified, curve) 返回曲线求值结果。
固定 player、Mana、false；SecretWhenUnitPowerRestricted/SecretWhenCurveSecret，
